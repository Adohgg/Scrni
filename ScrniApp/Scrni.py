...
class ImageHandle():
    ...
    def capture_desktop(self, event):
        im=ImageGrab.grab_to_file("penis.png")
        self.post_image()
    ...
    def capture_region(self, c1, c2):
        ...
        im=ImageGrab.grab(bbox=(p1.x, p1.y, p2.x - p1.x, p2.y - p1.y)).save("penis.png")
        self.post_image()

    def post_image(self):
        register_openers()
        datagen, headers = multipart_encode({"img": open("penis.png", "rb")})
